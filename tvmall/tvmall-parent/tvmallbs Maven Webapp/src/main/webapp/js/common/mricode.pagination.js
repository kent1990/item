...
(function (factory) {
    ...
    var Page = function (element, options) {
        ...
        this.options.pageSizeItems = options.pageSizeItems &&  defaultOption.pageSizeItems ? options.pageSizeItems:defaultOption.pageSizeItems ;
        ...
        getAjax: function (pagination, url, data, success, beforeSend, complate) {
            $.ajax({
                ...
                complete: function (XMLHttpRequest, textStatue) {
			    	...
			    	var redirectLocation = XMLHttpRequest.getResponseHeader("location");
			   		if(sessionStatus=="sessionTimeOut"){				      
			      		$.Showmsg("会话超时，请重新登录！即将跳转到登录页。。。");
