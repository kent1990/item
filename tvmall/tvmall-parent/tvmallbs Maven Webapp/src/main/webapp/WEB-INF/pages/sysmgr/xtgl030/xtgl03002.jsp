		...
		<form class="layui-form" action="" style="margin:40px;">
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="role_name" required lay-verify="name"
                ...
                $.ajax({
                    ...
                    success:function(json){
                        ...
                        if(json.status == 200){
                            ...
                            parent.layer.msg("角色添加成功", {icon: 6,time: 2000});
                        } else{
                        	layer.msg("角色添加失败", {icon: 5,time: 2000});
                        }
                    }
                });
                return false;
