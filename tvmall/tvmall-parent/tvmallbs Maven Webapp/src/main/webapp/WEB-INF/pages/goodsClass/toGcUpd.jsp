	    ...
	    <div class="layui-inline">
	      ...
	      <div class="layui-input-block">
                <div class="fileupload-block" style="width:${imgW}px;height:${imgH}px;">
					...
					<img class="fileupload-image" id="Img" src='${dfsPath}' tValue=""
	                ...
	                <label for="updinput" class="fileupload-file" title="点击上传图片" style="width:${imgW}px;height:${imgH}px;">
	                     <input type="file"  accept=".jpg,.gif,.png,.jpeg,.bmp" class="image" id="updinput" name="image" 
	                        data-url="goodsClass/uploadImage.do" wValue="${imgW}" hValue="${imgH}"
	...
	layui.config({
	  ...
	  $("#updinput").fileupload({
		...
		window.upload = function (){
			...
			$.post("goodsClass/uploadCanvas.do",{"canvasData":cut,"gcId":"${goodId}","delFile":delFile},function(json){
				if(json.statusCode=="200"){
