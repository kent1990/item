...
/**
 * TvOrder entity. @author MyEclipse Persistence Tools
 */

public class TvOrder implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2029047178018383761L;
	...
	private Double integralHandsel;
	...
	/** minimal constructor */
	public TvOrder(String orderSn, String userId, String userName,
			Double goodsAmount, Double arrivedAmount, Double shippingFee,
			Double orderAmount, Short orderState, Integer servicePointId,
			String receiverName, String receiverAddress, String receiverPhone,
			Integer receiveProvinceId, Integer receiveCityId,
			Short receiptMethod, Short isExperie) {
	...
	/** full constructor */
	public TvOrder(String orderSn, String userId, String userName,
			String userCardNumber, String addTime, String finishTime,
			String paySn, Double goodsAmount, Double arrivedAmount,
			Double shippingFee, Double orderAmount, Short orderState,
			String orderMsg, Double integralHandsel, Integer servicePointId,
			String shippingTime, String deliverExplain, String receiverName,
			String receiverAddress, String receiverPhone,
			Integer receiveProvinceId, Integer receiveCityId,
			String deliveryTime, Short receiptMethod, Short isExperie,
			Short payMethod, Short isReturngoods) {
		this.orderSn = orderSn;
		this.userId = userId;
		this.userName = userName;
	...
	public void setArrivedAmount(Double arrivedAmount) {
		this.arrivedAmount = arrivedAmount;
	}
	...
	public Double getIntegralHandsel() {
		return this.integralHandsel;
	}

	public void setIntegralHandsel(Double integralHandsel) {
		this.integralHandsel = integralHandsel;
	}
