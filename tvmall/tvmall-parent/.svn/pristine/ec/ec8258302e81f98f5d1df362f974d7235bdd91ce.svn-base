...
<script type="text/javascript">
    ...
    var setting = {
        async: {
            ...
            url: "goodsClass/tree.do?tmp="+ Math.random(),						 	// Ajax 获取数据的 URL 地址 
    ...
    function select(event, treeId, treeNode) {
        ...
        $("#goodsClassDetails").load("goodsClass/toGcUpd.do?gcId="+treeNode.id+"&treeNodeLevel="+treeNode.level+"&treeNodeName="+treeNode.name);
    }
    ...
    <div style="float: left; display: block; margin: 0px 10px; overflow: auto; width: 240px;
        height: 763px; border: solid 1px #CCC; background: #FFF;" >
            <div class="layui-btn-group">
               <a href="javascript:void(0);" id="btnAddParent" url="goodsClass/addParentClass.do" class="layui-btn layui-btn-sm"><i class="layui-icon">&#xe654;</i>添加根分类</a>
               <a href="javascript:void(0);" style="display: none" url="goodsClass/addSubClass.do" id="btnAddSub" class="layui-btn layui-btn-sm"><i class="layui-icon">&#xe654;</i>添加子分类</a>
            </div>         
           <div>
