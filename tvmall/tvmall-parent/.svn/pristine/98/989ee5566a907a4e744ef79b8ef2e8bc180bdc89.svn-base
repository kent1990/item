...
function(e) {
                    ...
                    if (void 0 !== h && null !== h || (h = ""), !(n.colspan > 1)) {
                        ...
                        function() {
                            ...
                            function() {
                                ...
                                /* modified by xuejy @20180629 
                                  set one row's checkBox to disabled
                                  ep:<th lay-data="{checkbox:true,disabledKey:'login_name',disabledKeyValue:'admin'}"></th>
                                  start>>>>
                                */
                                //console.log(e[n.disabledKey]+"-----"+n.disabledKeyValue);
                                var str = n.disabledKeyValue;
                                if(str){
	                                var arr = str.split(',');
	                                //var sss = layui.$.inArray(e[n.disabledKey], arr);
	                                //console.log(sss);
	                                if(n.disabledKey&&n.disabledKeyValue
	                                		&&layui.$.inArray(e[n.disabledKey], arr)!=-1){
	                                	return "disabled";
	                                }
                                }
                                /*modified by xuejy @20180629
    ...
    A.prototype.events = function() {
        ...
        /* modifiey by xuejy@20180702 */
        a.elem.on("click", 'input[name="layTableCheckbox"]:enabled+',
        function() {
            var e = t(this).prev(),
