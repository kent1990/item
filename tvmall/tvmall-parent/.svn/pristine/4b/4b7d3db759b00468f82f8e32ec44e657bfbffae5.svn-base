...
<html>
  <head>
    ...
    <link href="css/business/account/deliveryTime.css" type="text/css" rel="stylesheet" />
  </head>
  ...
  <body style="background:url(images/common/bg3.png) center #264677 no-repeat;width:100%;height:720px;">
    ...
    <div id="container_mid">
     	...
     	<div id="container_mid_2" class="container_mid_2_0"></div> 
	...
	<script type="text/javascript" src="deliveryTime.do?r=${tmp}"></script>
	<script type="text/javascript" src="js/common/tvcommon/wb_ScrollList.min.js"></script>
	<script type="text/javascript" src="js/business/list/accountCenter/deliveryTime.js"></script>
</html>
