...
<html>
  ...
  <body style="background:url(images/common/bg3.png) center #264677 no-repeat;width:1280px;height:720px;">

	<div class="container_head">
        <div id="div_3_0">
        	<img src="images/common/arrow.png">
        </div>
        <div id="title">电视商圈 | 打折促销</div>
        <div class="head_time">
	...
	<script type="text/javascript" src="discountData.do?r=${tmp}"></script> <!-- 查询数据 -->
	<script type="text/javascript" src="js/common/tvcommon/wb_ScrollList.min.js"></script>
	<script type="text/javascript" src="js/business/list/discountList.js"></script>
</html>
