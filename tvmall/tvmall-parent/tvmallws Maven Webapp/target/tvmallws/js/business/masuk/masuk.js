...
arrFocus[2] = {
		...
		doFocus: function(){			
			...
			$e('div_list2_' + obj.focusId).style.padding=27;
			$e('div_list2_' + obj.focusId).style.top="106px";
			$e('div_list2_' + obj.focusId).style.left="693px";
			$e('div_list2_' + obj.focusId).className='div_selected';
			clearInterval(myInterval);
			var i = 1;
			myInterval=setInterval(function(){
					$e('div_list2_' + obj.focusId).className='div_selected bg3_'+i;
					i++;
					if(i>2) i=1;
			}, 500);
		},
		doBlur: function(){
			...
			$e('div_list2_' + obj.focusId).style.padding=0;
			$e('div_list2_' + obj.focusId).style.top="133px";
			$e('div_list2_' + obj.focusId).style.left="720px";			
			clearInterval(myInterval);
		},
		limit:1,
		len:1,
    ...
    */
	setCont : function($this, startId, len){
		...
		for(var dataIndex = startId, index = 0; dataIndex < startId + arrFocus[2].len; dataIndex++){
		    ...
		    pic_html+='<div  id="div_num1_2" class="div_num1_2" ></div>';
		    var adom = "#div_list2_" +index;
			$(adom).append(pic_html);
		    index++;
		}		
