...
function funKeyPressOk(){
    ...
    window.location.href = "toGoodsDetail.do?goodsId="+dataList[startId + focusId].commonGoodsId
						+"&type="+dataList[startId + focusId].type+"&pageTitle= 销售排行 | 商品详情&r="+Math.random();    
}
