...
function funKeyPressOk(){
    ...
    window.location.href = "toTypeGoodList.do?typeId="+dataList[startId + focusId].typeId+"&r="+Math.random();    
}
	...
	setCont : function($this,startId, len){
		...
		for(var dataIndex = startId, index = 0; dataIndex < startId + len; dataIndex++){
			 ...
			 var pic_html = '<div class="pic">'+
			    '<img src="view.do?path=' + dataList[dataIndex].picPath + '" alt='+dataList[dataIndex].typeName+'></div>';
			    var desc_html = '<div class="desc"><div class="name">' + dataList[dataIndex].typeName + '</div></div>';          
			    var adom = "#div_0_" +index;		
